...
public class DirectMessageService {
    ...
    public DirectMessageDTO sendDirectMessage(String from, String to, String content) {
        ...
        return DirectMessageDTO.build(dmRepo.save(dm));
    }

    @Transactional(readOnly = true)
    public List<DirectMessageDTO> getInbox(String username) {
        ...
        return dmRepo.findInbox(user).stream()
                ...
                .map(DirectMessageDTO::build)
                .collect(Collectors.toList());
    }

    @Transactional(readOnly = true)
    public List<DirectMessageDTO> getConversation(String u1, String u2) {
